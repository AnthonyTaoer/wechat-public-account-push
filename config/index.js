...
const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: 'wx82168bf6713ad80d',

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: 'fb51598b92ca3f60d2f9f8dc20d6dec9',
  ...
  USERS: [
    {
      ...
      id: 'oJGS_6uulCtqJUpGOoUnjPwBBpFk,oJGS_6sOQYrC-7TSwVnldczaYd-I',
      // 你想对他发送的模板消息的模板ID
      useTemplateId: '7wjovIjrUNcCyDoTxHAgoXfw7ngvaEq-b0Y9JH8Ugkw',
      // 所在省份
      province: '江苏',
      // 所在城市
      city: '徐州',
      ...
      festivals: [
        ...
        {
          type: '*生日', name: '小可爱', year: '2002', date: '03-18',
        } 
      ],
  ...
  CALLBACK_TEMPLATE_ID: 'yNVWzN3-3MvJAAsZCxphQgnY7Fef21oMjkw_UxYb1Ek',
  ...
  CALLBACK_USERS: [
    {
      ...
      id: 'oJGS_6uulCtqJUpGOoUnjPwBBpFk',
    }
    // 你可以不断按格式往下增加
    // ...
  ],
